...
public class UserAgentUtils {
    ...
    static {
        frequency.put("Internet Explorer", 11.8);
        frequency.put("Firefox", 28.2);
        frequency.put("Chrome", 52.9);
        frequency.put("Safari", 3.9);
        frequency.put("Opera", 1.8);

        userAgents.put("Internet Explorer", new String[] {
        ...
        userAgents.put("Firefox", new String[] {
        ...
        userAgents.put("Chrome", new String[] {
        ...
        userAgents.put("Safari", new String[] {
        ...
        userAgents.put("Opera", new String[] {
    ...
    public static String getRandomUserAgent() {
        ...
        for(Entry<String, Double> freq : frequency.entrySet()) {
            count += freq.getValue();
            if(rand <= count) {
                browser = freq.getKey();
                break;
        ...
        String[] userAgents = UserAgentUtils.userAgents.get(browser);
